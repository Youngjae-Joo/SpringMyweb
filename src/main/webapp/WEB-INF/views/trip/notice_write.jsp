					...
					<ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" id="datepicker_a" name="tripdate" placeholder="날짜를 선택하세요" required="required">
                            </div>
						</li>
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" name="title" class="w100p" id="name_lbl" placeholder="제목을 입력하세요" required="required"/></div>
						</li>
